...
var Guest2 = (function (_super) {
    __extends(Guest2, _super);
    function Guest2(stage, x, y, z, img) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
        if (z === void 0) { z = 0; }
        ...
        _this.gHead = AWResourceManager_1.AWResourceManager.getInstance().resources('guest_head2Img');
    ...
    Guest2.prototype.onDraw = function (context) {
    ...
    Guest2.prototype.onCreate = function (data) {
    };
    Guest2.prototype.onDestroy = function (data) {
    };
    Guest2.prototype.onPause = function (data) {
    };
    Guest2.prototype.onRestart = function (data) {
    };
    Guest2.prototype.onResume = function (data) {
    };
    Guest2.prototype.onStart = function (data) {
        var _this = this;
        this.initSetting();
        this.resizeSubscription = this.stage.canvasEventSubscribe('resize', function (event) { return _this.initSetting(); });
    };
    Guest2.prototype.onStop = function (data) {
        if (!ValidUtil_1.ValidUtil.isNullOrUndefined(this.resizeSubscription)) {
            this.resizeSubscription.unsubscribe();
        }
    };
    Guest2.prototype.initSetting = function () {
        ...
        this.translatePosition = new PointVector_1.PointVector((this.stage.width / 2) - 100, 0);
    };
    return Guest2;
}(AWObj_1.AWObj));
exports.Guest2 = Guest2;
