...
var Guest1 = (function (_super) {
    __extends(Guest1, _super);
    function Guest1(stage, x, y, z, img) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
        if (z === void 0) { z = 0; }
        ...
        _this.gHead = AWResourceManager_1.AWResourceManager.getInstance().resources('guest_head1Img');
    ...
    Guest1.prototype.onDraw = function (context) {
    ...
    Guest1.prototype.onCreate = function (data) {
    };
    Guest1.prototype.onDestroy = function (data) {
    };
    Guest1.prototype.onPause = function (data) {
    };
    Guest1.prototype.onRestart = function (data) {
    };
    Guest1.prototype.onResume = function (data) {
    };
    Guest1.prototype.onStart = function (data) {
        var _this = this;
        this.initSetting();
        this.resizeSubscription = this.stage.canvasEventSubscribe('resize', function (event) { return _this.initSetting(); });
    };
    Guest1.prototype.onStop = function (data) {
        if (!ValidUtil_1.ValidUtil.isNullOrUndefined(this.resizeSubscription)) {
            this.resizeSubscription.unsubscribe();
        }
    };
    Guest1.prototype.initSetting = function () {
        ...
        this.translatePosition = new PointVector_1.PointVector(-25, 30);
    };
    return Guest1;
}(AWObj_1.AWObj));
exports.Guest1 = Guest1;
