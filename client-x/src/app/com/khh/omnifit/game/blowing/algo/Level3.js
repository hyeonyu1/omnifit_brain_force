...
var Level3 = (function (_super) {
    ...
    function Level3(uuid, host, name) {
        var _this = _super.call(this, uuid, host) || this;
        _this.name = name;
        return _this;
    }
    Level3.prototype.onCreate = function (data) {
        var _this = this;
        this.concentrationSubscription = DeviceManager_1.DeviceManager.getInstance().headsetConcentrationSubscribe(function (concentration) {
            if (RandomUtil_1.RandomUtil.random(0, 100) <= 80) {
    ...
    Level3.prototype.onPause = function (data) {
        return this;
    };
    Level3.prototype.onRestart = function (data) {
        return this;
    };
    Level3.prototype.onResume = function (data) {
        return this;
    };
    Level3.prototype.onStart = function (data) {
        return this;
    };
    Level3.prototype.onStop = function (data) {
        return this;
    };
    Level3.prototype.onDestroy = function (data) {
